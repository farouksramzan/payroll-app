...
const INPUT_STYLE = {
  ...
  fontSize: '0.8667rem', color: 'var(--text-primary)',
    ...
    <div className="card" style={{ maxWidth: 600 }}>
      ...
      <div style={{ padding: '20px 24px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
          <h3 style={{ margin: 0, fontSize: '1.0667rem', fontWeight: 800, color: 'var(--text-primary)' }}>
            W-4 Withholding Setup
          </h3>
          {step <= TOTAL_STEPS && (
            <span style={{ fontSize: '0.7333rem', color: 'var(--text-muted)', fontWeight: 600 }}>
      ...
      <div style={{ padding: '0 24px 24px' }}>
              ...
              {FILING_OPTIONS.map(opt => (
                <label
                  ...
                  style={{
                    ...
                    background: w4.filingStatus === opt.value ? 'rgba(45,106,79,0.06)' : 'var(--bg)',
                ...
                >
                  ...
                  />
                  <div>
                    <div style={{ fontSize: '0.8667rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: 2 }}>
                      {opt.label}
                    </div>
              ...
              {[
                ...
                <label
                  ...
                  style={{
                    ...
                    background: w4.step2Checkbox === opt.val ? 'rgba(45,106,79,0.06)' : 'var(--bg)',
                    transition: 'all 0.15s',
                  }}
                >
                  <input
                  ...
                  />
                  <span style={{ fontSize: '0.8667rem', fontWeight: 600, color: 'var(--text-primary)' }}>{opt.label}</span>
                </label>
              ))}
            </div>
            <div style={{
          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{
                ...
                <div style={{ fontSize: '0.8667rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <button
                    ...
                    style={{ width: 32, height: 32, borderRadius: 6, border: '1.5px solid var(--border)', background: 'var(--bg-secondary)', cursor: 'pointer', fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  >−</button>
                  <span style={{ fontSize: '1.4667rem', fontWeight: 800, color: 'var(--text-primary)', minWidth: 32, textAlign: 'center' }}>{w4.step3Children}</span>
                  <button
                    type="button"
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <button
                    ...
                    style={{ width: 32, height: 32, borderRadius: 6, border: '1.5px solid var(--border)', background: 'var(--bg-secondary)', cursor: 'pointer', fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  >−</button>
                  <span style={{ fontSize: '1.4667rem', fontWeight: 800, color: 'var(--text-primary)', minWidth: 32, textAlign: 'center' }}>{w4.step3Other}</span>
                  <button
                    type="button"
              ...
              {dependentCredit > 0 && (
                <div style={{
                  ...
                  fontSize: '0.8667rem', color: 'var(--success)', fontWeight: 600,
                }}>
        ...
        {step === 4 && (
          <>
            <p style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>
              Any other adjustments? <span style={{ fontWeight: 500, color: 'var(--text-muted)', fontSize: '0.8667rem' }}>(optional)</span>
            </p>
            <p style={{ fontSize: '0.8667rem', color: 'var(--text-muted)', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                ...
                <div key={field.key}>
                  <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, color: 'var(--text-secondary)', marginBottom: 2, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                    {field.label}
                  </label>
                  <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: 6 }}>{field.desc}</div>
        ...
        {step === 5 && (
          <div style={{ padding: '4px 0 8px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
              ...
              <div>
                <div style={{ fontSize: '0.9333rem', fontWeight: 700, color: 'var(--text-primary)' }}>W-4 on file</div>
                <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Your preferences are saved and used for payroll calculations.</div>
              </div>
              <div style={{ flex: 1 }} />
            ...
            <div style={{ border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden' }}>
              {[
                ...
                <div key={row.label} style={{
                  ...
                  <div>
                    <div style={{ fontSize: '0.8667rem', fontWeight: 600, color: 'var(--text-primary)' }}>{row.label}</div>
                    <div style={{ fontSize: '0.7333rem', color: 'var(--text-muted)', marginTop: 1 }}>{row.sub}</div>
                  </div>
                  <div style={{ fontSize: '0.8667rem', color: 'var(--text-secondary)', fontWeight: 500, textAlign: 'right', maxWidth: '55%' }}>
                    {row.value}
                  </div>
                </div>
              ))}
        ...
        {saveMsg && step !== 5 && (
          <div style={{ marginTop: 12, padding: '8px 14px', borderRadius: 6, background: 'var(--error-light)', border: '1px solid var(--error)', fontSize: '0.8667rem', color: 'var(--error)' }}>
            {saveMsg}
          </div>
        )}
...
function FieldRow({ label, value, last }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: last ? 'none' : '1px solid var(--border-light)' }}>
      ...
      <span style={{ color: 'var(--text-primary)', fontSize: '0.8667rem', fontWeight: 500 }}>{value || '—'}</span>
    </div>
  );
}
...
function FormField({ label, children }) {
  return (
    <div>
      <label style={{ display: 'block', fontSize: '0.7333rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: '0.04em' }}>{label}</label>
      {children}
    </div>
  );
}
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <button
        type="button"
        onClick={() => setShow(s => !s)}
        style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-muted)', fontSize: '0.8rem', fontWeight: 600, padding: '2px 4px' }}
      >
        {show ? 'Hide' : 'Show'}
      </button>
    </div>
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-secondary)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        {me && (
          <>
            ...
            <div style={{ fontSize: '0.8667rem', fontWeight: 600, color: 'rgba(255,255,255,0.85)' }}>{me.firstName} {me.lastName}</div>
            {me.companyName && (
              <>
                <div style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.9333rem' }}>at</div>
                <div style={{ fontSize: '0.8667rem', fontWeight: 600, color: 'rgba(255,255,255,0.7)' }}>{me.companyName}</div>
              </>
            )}
          </>
        )}
        <div style={{ flex: 1 }} />
        <span style={{ fontSize: '0.8667rem', color: 'rgba(255,255,255,0.65)' }}>{user?.email || user?.username}</span>
        <button
          onClick={logout}
          style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 6, padding: '6px 14px', color: '#fff', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer' }}
        >
          Sign out
        </button>
      </div>
      ...
      <div style={{ flex: 1, maxWidth: 860, margin: '0 auto', width: '100%', padding: '28px 24px' }}>
        ...
        {error && (
          <div style={{ background: 'var(--error-light)', border: '1px solid var(--error)', borderRadius: 6, padding: '10px 16px', marginBottom: 20, fontSize: '0.8667rem', color: 'var(--error)' }}>
            {error}
          </div>
        )}
        ...
        {me && (
          <div style={{ marginBottom: 24 }}>
            <h2 style={{ fontSize: '1.4667rem', fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '-0.3px', margin: 0 }}>
              {me.firstName} {me.lastName}
            </h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.8667rem', marginTop: 4, marginBottom: 0 }}>
          ...
          {TABS.map(([k, label]) => (
            <button
              ...
              style={{
                ...
                fontSize: '0.8667rem', color: tab === k ? 'var(--text-primary)' : 'var(--text-muted)',
                transition: 'all 0.15s',
              }}
            >
              {label}
        ...
        {tab === 'paystubs' && (
          <div className="card" style={{ padding: 0, overflowX: 'auto' }}>
            <div className="card-header" style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-light)' }}>
              ...
              <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>{paystubs.length} total</span>
            </div>
            {paystubs.length === 0 ? (
              <div style={{ padding: '48px 20px', textAlign: 'center' }}>
                <div style={{ fontSize: '2.1333rem', marginBottom: 12 }}>📄</div>
                <div style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: 6 }}>No pay records yet</div>
                <div style={{ fontSize: '0.8667rem', color: 'var(--text-muted)' }}>Your accountant will post them here when available.</div>
              </div>
            ) : (
                ...
                <thead>
                  <tr style={{ background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border)' }}>
                    {['Period', 'Gross Pay', 'Fed. Tax', 'SS Tax', 'Medicare', 'Net Pay', ''].map((h, i) => (
                      <th key={i} style={{ padding: '10px 18px', textAlign: h === 'Period' || h === '' ? 'left' : 'right', fontSize: '0.7333rem', color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {paystubs.map(p => (
                    <Fragment key={p.id}>
                      ...
                      >
                        <td style={{ padding: '13px 18px', fontSize: '0.8667rem', fontWeight: 600 }}>Q{p.tax_quarter} {p.tax_year}</td>
                        <td style={{ padding: '13px 18px', textAlign: 'right', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8667rem' }}>{fmt(p.gross_wages)}</td>
                        <td style={{ padding: '13px 18px', textAlign: 'right', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8667rem' }}>{fmt(p.fit_withholding)}</td>
                        <td style={{ padding: '13px 18px', textAlign: 'right', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8667rem' }}>{fmt(p.employee_ss)}</td>
                        <td style={{ padding: '13px 18px', textAlign: 'right', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8667rem' }}>{fmt(p.employee_medicare)}</td>
                        <td style={{ padding: '13px 18px', textAlign: 'right', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.8667rem', color: 'var(--accent)', fontWeight: 700 }}>{fmt(p.net_pay)}</td>
                        <td style={{ padding: '13px 18px', fontSize: '0.8rem', color: 'var(--accent)', fontWeight: 600, whiteSpace: 'nowrap' }}>
                          ...
                          <td colSpan={7} style={{ padding: '16px 18px' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
                              {[
                                ...
                                <div key={label}>
                                  <div style={{ fontSize: '0.6667rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 2 }}>{label}</div>
                                  <div style={{ fontSize: '0.8667rem', fontWeight: label === 'Net Pay' ? 700 : 500, color: label === 'Net Pay' ? 'var(--accent)' : 'var(--text-primary)', fontFamily: label.includes('Period') || label.includes('Date') ? 'inherit' : 'JetBrains Mono, monospace' }}>{value}</div>
                                </div>
                              ))}
                            </div>
                            <div style={{ fontSize: '0.7333rem', color: 'var(--text-muted)', marginTop: 12 }}>
        ...
        {tab === 'profile' && me && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {saveMsg?.type === 'success' && (
              <div style={{ background: 'var(--success-light)', border: '1px solid var(--success)', borderRadius: 6, padding: '10px 16px', fontSize: '0.8667rem', color: 'var(--success)', fontWeight: 600 }}>
                {saveMsg.text}
              </div>
            )}
            ...
            <div className="card">
              <div className="card-header">
                ...
                <span style={{ fontSize: '0.7333rem', color: 'var(--text-muted)' }}>Set by your accountant</span>
              </div>
            ...
            <div className="card">
              ...
              {editSection === 'tax' ? (
                <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  {saveMsg?.type === 'error' && <div style={{ fontSize: '0.8rem', color: 'var(--error)' }}>{saveMsg.text}</div>}
                ...
                <>
                  ...
                  {!me.hasSSN && (
                    <div style={{ marginTop: 10, padding: '8px 12px', borderRadius: 6, background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', fontSize: '0.8rem', color: 'var(--error)' }}>
              ...
              {editSection === 'bank' ? (
                <form onSubmit={handleBankSave} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  <FormField label="Account Number">
                    ...
                    />
                    <div style={{ fontSize: '0.7333rem', color: 'var(--text-muted)', marginTop: 4 }}>Stored encrypted. Only the last 4 digits are visible after saving.</div>
                  </FormField>
